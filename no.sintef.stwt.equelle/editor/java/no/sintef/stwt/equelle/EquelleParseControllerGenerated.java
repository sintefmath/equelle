...
public class EquelleParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Equelle");
  ...
  { 
    EquelleParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EquelleParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EquelleParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EquelleParseControllerGenerated.class);
    }
  ...
  { 
    return EquelleParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
