...
var compileEquelle = function(source, conn, quit, handleAnother) {
    ...
    var compiler = tryAsync(false, exec, config.equelle_compiler+' --nondimensional --input - --backend cpu')
    .complete(function(stdout) {
        ...
        .complete(function(sign) {
            ...
            var parser = tryAsync(false, exec, config.equelle_compiler+' --nondimensional --input - --backend io')
